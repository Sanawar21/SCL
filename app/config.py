...
class Config:
    ...
    AUTH_DB_PATH = os.environ.get("SCL_AUTH_DB_PATH", "data/scl.sqlite3")
    AUCTION_DB_PATH = os.environ.get("SCL_AUCTION_DB_PATH", "data/scl.sqlite3")
    LEGACY_AUTH_DB_PATH = os.environ.get("SCL_LEGACY_AUTH_DB_PATH", "data/global_auth_db.json")
    LEGACY_AUCTION_DB_PATH = os.environ.get("SCL_LEGACY_AUCTION_DB_PATH", "data/auction_live_db.json")
